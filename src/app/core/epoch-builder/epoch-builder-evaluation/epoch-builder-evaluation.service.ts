...
export class EpochBuilderEvaluationService implements IEpochBuilderEvaluationService {
	...
	public readonly desc: IEpochBuilderEvaluationDescriptions = {
		...
		accuracyImprovement: "Evaluates the accuracy obtained in the first epoch vs the accuracy obtained \
		in the last epoch. In the case of accuracy, the higher the value the better.",
		accuracyVsValAccuracy: "Evaluates the last accuracy vs the last validation accuracy. In healthy models, the \
		validation accuracy should be higher than the train accuracy.",
		accuracy: "Evaluates the accuracy of predictions generated by the model. In the case of accuracy, the higher the better.",
		points: "Evaluates the trading points collected by the model during the process.",
		predictionNeutrality: "Evaluates the number of neutral and non-neutral predictions. When evaluating regressions, \
		it is suggested to pick the models with low/moderate neutrality.",
