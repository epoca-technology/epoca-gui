...
import { IBacktestPosition, IModel, IPrediction, IPredictionResult, PredictionBacktestingService, PredictionService, UtilsService } from '../../../core';
import { 
	AppService, 
	ChartService, 
	ClipboardService, 
...
export class PredictionBacktestingComponent implements OnInit, OnDestroy, IPredictionBacktestingComponent {
	...
	public fakeLongPrediction() {
		...
		this._nav.displayPredictionDialog(model, <IPrediction>pred);
	}



	public fakeShortPrediction() {
		let model = {
			"id": "ARIMA_CUSTOM_5",
			"single_models": [
				{
	...
	public fakeLongPredictionWithEMA() {
		let model = {
			"id": "ARIMA_CUSTOM_4",
			"single_models": [
				{
	...
	public fakeShortPredictionWithEMA() {
		let model = {
			"id": "ARIMA_CUSTOM_4",
			"single_models": [
				{
	...
	public fakeLongPredictionWithRSI() {
		let model = {
			"id": "ARIMA_CUSTOM_2",
			"single_models": [
				{
	...
	public fakeShortPredictionWithRSI() {
		let model = {
			"id": "ARIMA_CUSTOM_2",
			"single_models": [
				{
