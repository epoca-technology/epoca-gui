	...
	async ngOnInit(): Promise<void> {
		try {
			...
			this.form = new FormGroup ({
				...
				leverage: new FormControl(this.strategy.leverage, [ Validators.required, Validators.min(2), Validators.max(20) ]),
				position_size: new FormControl(this.strategy.position_size, [ Validators.required, Validators.min(25), Validators.max(10000) ]),
